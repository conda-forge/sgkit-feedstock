...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sgkit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12529&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sgkit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sgkit` can be installed with:

```
conda install sgkit
```

It is possible to list all of the versions of `sgkit` available on your platform with:
